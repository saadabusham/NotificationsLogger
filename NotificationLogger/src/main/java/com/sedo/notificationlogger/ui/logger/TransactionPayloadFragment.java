...
public class TransactionPayloadFragment extends Fragment implements TransactionFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.notification_logger_fragment_transaction_payload, container, false);
    ...
    private void populateUI() {
        if (isAdded() && transaction != null) {
            switch (type) {
                case TYPE_REQUEST:
                    setText(transaction.getTitle(),transaction.getDescription(),true);
                    break;
                case TYPE_RESPONSE:
                    setText(transaction.getTitle(),transaction.getDescription(),true);
                    break;
    ...
    private void setText(String headersString, String bodyString, boolean isPlainText) {
        ...
        if (!isPlainText) {
            body.setText(getString(R.string.logger_body_omitted));
        } else {
